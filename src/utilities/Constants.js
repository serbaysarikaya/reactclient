...
const development ={
    API_URL_GET_ALL_POST:`${API_BASE_URL_DEVELOPMENT}/${ENDPOINTS.GET_ALL_POSTS}`,
...
const production ={
    API_URL_GET_ALL_POST:`${API_BASE_URL_PRODUCTION}/${ENDPOINTS.GET_ALL_POSTS}`,
